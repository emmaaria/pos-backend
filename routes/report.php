...
Route::group(['middleware' => 'api'], function ($router) {
    ...
    Route::post('/report/purchase/by-supplier', [ReportController::class, 'purchaseBySupplier']);
    ...
    Route::post('/report/expense', [ReportController::class, 'generateExpenseReport']);
});
